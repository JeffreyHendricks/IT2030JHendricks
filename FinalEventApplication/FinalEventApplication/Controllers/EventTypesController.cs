...
namespace FinalEventApplication.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventTypeId,EventTypeTitle,EventTypeDescription")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventTypeId,EventTypeTitle,EventTypeDescription")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
