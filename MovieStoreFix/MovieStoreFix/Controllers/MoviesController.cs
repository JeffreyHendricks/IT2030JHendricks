...
namespace MovieStoreFix.Controllers
{
    public class MoviesController : Controller
    {
        private MovieStoreFixDBContext db;
        ...
        public List<Movie> ListOfMovies()
        {
            ...
            {
               new Movie {MovieId=1, Title="Terminator1"},
               new Movie {MovieId=2, Title="Terminator2"},
               new Movie {MovieId=3, Title="Terminator3"}
